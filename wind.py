    ...
    try:
        # while time.time() - start_time < duration:
            ...
            if(text == 0):
                ...
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'0', ('192.168.65.45', 12345))
                
                
            elif(text == 1):
                color_all(strip, Color(122, 0, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'1', ('192.168.65.45', 12345))
            
            elif(text == 2):
                color_all(strip, Color(183, 0, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'2', ('192.168.65.45', 12345))
            
            elif(text == 3):
                color_all(strip, Color(255, 0, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'3', ('192.168.65.45', 12345))
            
            elif(text == 4):
                color_all(strip, Color(0, 61, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'4', ('192.168.65.45', 12345))
            
            elif(text == 5):
                color_all(strip, Color(0, 122, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'5', ('192.168.65.45', 12345))
            
            elif(text == 6):
                color_all(strip, Color(0, 183, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'6', ('192.168.65.45', 12345))
            
            elif(text == 7):
                color_all(strip, Color(0, 255, 0), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'7', ('192.168.65.45', 12345))
            
            elif(text == 8):
                color_all(strip, Color(0, 0, 61), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'8', ('192.168.65.45', 12345))
            
            elif(text == 9):
                color_all(strip, Color(0, 0, 122), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'9', ('192.168.65.45', 12345))
            
            elif(text == 10):
                color_all(strip, Color(0, 0, 183), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'10', ('192.168.65.45', 12345))
            
            elif(text == 11):
                color_all(strip, Color(0, 0, 255), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'11', ('192.168.65.45', 12345))
            
            elif(text == 12):
                color_all(strip, Color(61, 61, 61), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'12', ('192.168.65.45', 12345))
            
            elif(text == 13):
                color_all(strip, Color(122, 122, 122), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'13', ('192.168.65.45', 12345))
            
            elif(text == 14):
                color_all(strip, Color(183, 183, 183), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'14', ('192.168.65.45', 12345))
                
            elif(text == 15):
                color_all(strip, Color(255, 255, 255), 10)
                with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as s:
                    s.sendto(b'15', ('192.168.65.45', 12345))
